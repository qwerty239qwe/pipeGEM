...
def plot_model_components(comp_df: pd.DataFrame,
    ...
    sns.boxplot(data=comp_df[comp_df["component"] == "reactions"], y="number", x="group", hue="group",
                palette="deep", order=order, ax=axes[0], dodge=False)
    sns.boxplot(data=comp_df[comp_df["component"] == "metabolites"], y="number", x="group", hue="group",
                palette="deep", order=order, ax=axes[1], dodge=False)
    sns.boxplot(data=comp_df[comp_df["component"] == "genes"], y="number", x="group", hue="group",
