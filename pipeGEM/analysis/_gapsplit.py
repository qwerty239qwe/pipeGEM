...
from pipeGEM.utils import usage_warning

# This file is from https://github.com/jensenlab/gapsplit/blob/master/python/gapsplit.py
# The reason why I added the gapsplit() function to this package was for integrating RIPTiDe into this package.
# So please cite the original paper if you use any function in this file
# (a warning will be printed if anything in the package call the functions here


user_warning = """
Please remember to cite https://github.com/jensenlab/gapsplit/blob/master/python/gapsplit.py 
since you have used the gapsplit function to sample fluxes
"""
